...
.method public final a([BII)I
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Lcom/google/android/play/core/assetpacks/cm;->e(I[BII)I
    ...
    invoke-static {v3, v4}, Lcom/google/android/play/core/assetpacks/ck;->e([BI)I
    ...
    invoke-direct {p0, v3, p1, p2, p3}, Lcom/google/android/play/core/assetpacks/cm;->e(I[BII)I
    ...
    :cond_3
    iget-boolean p2, p0, Lcom/google/android/play/core/assetpacks/cm;->h:Z

    if-nez p2, :cond_4

    iget-object p2, p0, Lcom/google/android/play/core/assetpacks/cm;->i:Ljava/lang/String;

    if-nez p2, :cond_4

    new-instance p2, Ljava/lang/String;

    iget-object p3, p0, Lcom/google/android/play/core/assetpacks/cm;->a:[B

    iget v2, p0, Lcom/google/android/play/core/assetpacks/cm;->e:I

    invoke-direct {p2, p3, v0, v2}, Ljava/lang/String;-><init>([BII)V

    iput-object p2, p0, Lcom/google/android/play/core/assetpacks/cm;->i:Ljava/lang/String;
...
.method public final b()Lcom/google/android/play/core/assetpacks/de;
    ...
    iget v1, p0, Lcom/google/android/play/core/assetpacks/cm;->f:I

    if-ge v0, v1, :cond_0

    iget-object v2, p0, Lcom/google/android/play/core/assetpacks/cm;->i:Ljava/lang/String;

    iget-wide v3, p0, Lcom/google/android/play/core/assetpacks/cm;->d:J

    iget v5, p0, Lcom/google/android/play/core/assetpacks/cm;->g:I

    const/4 v6, 0x1

    iget-object v1, p0, Lcom/google/android/play/core/assetpacks/cm;->a:[B

    invoke-static {v1, v0}, Ljava/util/Arrays;->copyOf([BI)[B

    move-result-object v7

    iget-boolean v8, p0, Lcom/google/android/play/core/assetpacks/cm;->h:Z

    invoke-static/range {v2 .. v8}, Lcom/google/android/play/core/assetpacks/de;->a(Ljava/lang/String;JIZ[BZ)Lcom/google/android/play/core/assetpacks/de;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/play/core/assetpacks/cm;->i:Ljava/lang/String;

    iget-wide v2, p0, Lcom/google/android/play/core/assetpacks/cm;->d:J

    iget v4, p0, Lcom/google/android/play/core/assetpacks/cm;->g:I

    const/4 v5, 0x0

    iget-object v6, p0, Lcom/google/android/play/core/assetpacks/cm;->a:[B

    invoke-static {v6, v1}, Ljava/util/Arrays;->copyOf([BI)[B

    move-result-object v6

    iget-boolean v7, p0, Lcom/google/android/play/core/assetpacks/cm;->h:Z

    move-object v1, v0

    invoke-static/range {v1 .. v7}, Lcom/google/android/play/core/assetpacks/de;->a(Ljava/lang/String;JIZ[BZ)Lcom/google/android/play/core/assetpacks/de;
