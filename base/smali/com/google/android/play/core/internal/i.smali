...
.method static a(Ljava/io/RandomAccessFile;)Landroid/util/Pair;
    ...
    invoke-static {p0, v0}, Lcom/google/android/play/core/internal/i;->h(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
...
.method public static b(Ljava/nio/ByteBuffer;)J
    ...
    invoke-static {p0}, Lcom/google/android/play/core/internal/i;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, v0}, Lcom/google/android/play/core/internal/i;->j(Ljava/nio/ByteBuffer;I)J
...
.method public static g(Ljava/lang/String;)[[Ljava/security/cert/X509Certificate;
    ...
    invoke-static {v11}, Lcom/google/android/play/core/internal/i;->d(Ljava/nio/ByteBuffer;)J
    ...
    invoke-static {v0, v3}, Lcom/google/android/play/core/internal/i;->r(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v2, v0}, Lcom/google/android/play/core/internal/i;->k(Ljava/nio/channels/FileChannel;Lcom/google/android/play/core/internal/e;)[[Ljava/security/cert/X509Certificate;
...
.method private static h(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
    ...
    invoke-static {p1}, Lcom/google/android/play/core/internal/i;->i(Ljava/nio/ByteBuffer;)V
...
.method private static k(Ljava/nio/channels/FileChannel;Lcom/google/android/play/core/internal/e;)[[Ljava/security/cert/X509Certificate;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/SecurityException;
    ...
    invoke-static {v2}, Lcom/google/android/play/core/internal/i;->s(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v4, v0, v1}, Lcom/google/android/play/core/internal/i;->l(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-static/range {v0 .. v8}, Lcom/google/android/play/core/internal/i;->m(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
...
.method private static l(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/play/core/internal/i;->s(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/play/core/internal/i;->t(Ljava/nio/ByteBuffer;)[B
    ...
    :try_start_0
    invoke-static {v1}, Lcom/google/android/play/core/internal/i;->s(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v6}, Lcom/google/android/play/core/internal/i;->o(I)I

    move-result v11

    invoke-static {v7}, Lcom/google/android/play/core/internal/i;->o(I)I
    ...
    :cond_2
    invoke-static {v10}, Lcom/google/android/play/core/internal/i;->t(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-static {v0}, Lcom/google/android/play/core/internal/i;->s(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v8}, Lcom/google/android/play/core/internal/i;->t(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-static {v1}, Lcom/google/android/play/core/internal/i;->p(I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/android/play/core/internal/i;->t(Ljava/nio/ByteBuffer;)[B
...
.method private static m(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
    ...
    invoke-static {v2, p2, p3}, Lcom/google/android/play/core/internal/i;->c(Ljava/nio/ByteBuffer;J)V
    ...
    invoke-static {v4, v5}, Lcom/google/android/play/core/internal/i;->n([I[Lcom/google/android/play/core/internal/c;)[[B
...
.method private static n([I[Lcom/google/android/play/core/internal/c;)[[B
    ...
    invoke-static {v10}, Lcom/google/android/play/core/internal/i;->q(I)I
    ...
    invoke-static {v4, v10}, Lcom/google/android/play/core/internal/i;->u(I[B)V
    ...
    invoke-static {v2, v4}, Lcom/google/android/play/core/internal/i;->u(I[B)V
    ...
    :try_start_1
    invoke-interface {v3, v6, v7, v8, v2}, Lcom/google/android/play/core/internal/c;->b([Ljava/security/MessageDigest;JI)V
    :try_end_1
...
.method private static r(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method private static s(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, v0}, Lcom/google/android/play/core/internal/i;->r(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
